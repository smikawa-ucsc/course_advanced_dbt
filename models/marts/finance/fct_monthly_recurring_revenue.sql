...
{% set import_subscriptions = unit_testing_select_table(ref('dim_subscriptions'),ref('dim_subscriptions_sample')) %}
{% set import_dates = unit_testing_select_table(ref('dim_dates'),ref('dim_dates_full')) %}
